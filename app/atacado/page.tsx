    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="mx-auto max-w-6xl px-4 py-8">
        <h1 className="text-center text-2xl font-extrabold tracking-tight text-foreground sm:text-3xl">
          CATÁLOGO DE COMPRAS COLETIVAS
        </h1>
        <p className="mx-auto mt-2 max-w-2xl text-center text-sm text-muted-foreground">
          Veja os produtos disponíveis e entre no grupo de WhatsApp da categoria pra participar das
          próximas caixas em compra coletiva.
        </p>

        <div className="mt-8">
          <VitrineCategoriaStrip categorias={categorias} categoriaAtiva={categoria} basePath="/atacado" />
        </div>
