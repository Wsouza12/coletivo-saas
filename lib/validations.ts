...
export const configuracaoFinanceiraSchema = z.object({
  ...
  docRemetente: z.string().optional(),
...
export const criarProdutoAtacadoSchema = z.object({
  ...
  minimoUnidadesPadrao: z.number().int().min(1).optional().default(1),
...
export const preCadastroItemCatalogoSchema = z.object({
  ...
  minimoUnidadesPadrao: z.coerce.number().int().min(1).optional().default(1),
